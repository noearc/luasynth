...
function defs.processSamplePair(state, l, r)
	...
	outL = processSample(l, n, state.xLeft, state.yLeft, state.c1, state.c2, state.c3, state.c4, state.c5)
	outR = processSample(r, n, state.xRight, state.yRight, state.c1, state.c2, state.c3, state.c4, state.c5)
	state.n = n
	return outL, outR
end
